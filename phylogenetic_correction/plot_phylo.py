...
b=0.10768; xx=np.linspace(d.rx.min(),d.rx.max(),50)
ax.plot(xx,b*xx+(d.ry.mean()-b*d.rx.mean()),c='black',lw=3,zorder=6)
...
fig.savefig('phylo_stacked.png',dpi=230,bbox_inches='tight',facecolor='white')
print('saved stacked')
